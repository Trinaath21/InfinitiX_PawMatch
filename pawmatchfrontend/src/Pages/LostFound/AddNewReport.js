...
async function fetchAddressFromCoordinates(lat, lng) {
  ...
  const district =
    ...
    addressComponents.town; // Adjust as needed
    ...
    () => ({
      dragend() {
        ...
        if (marker != null) {
          ...
          fetchAddressFromCoordinates(newLatLng.lat, newLatLng.lng).then(
            ({ fullAddress, district, state, lat, lng }) => {
              if (fullAddress) {
  ...
  function LocationMarker() {
    ...
    const map = useMapEvents({
      ...
      locationfound(e) {
        ...
        fetchAddressFromCoordinates(e.latlng.lat, e.latlng.lng).then(
          (address) => {
            if (address) {
  ...
  const formik = useFormik({
    ...
    validationSchema: Yup.object({
      ...
      age: Yup.number()
        ...
        .min(0, "Age must be a positive number"), // Validation for age
      size: Yup.number()
        .required("Size is required")
        .min(0, "Size must be a positive number"), // Validation for size
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        const response = await axios.post(
          "http://localhost:8000/api/addlost-pets",
          formData,
          {
            headers: {
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12}>
            <Form.Item
              ...
              required
              validateStatus={
                formik.touched.breed && formik.errors.breed ? "error" : ""
              }
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24} sm={12}>
            <Form.Item
              ...
              label="Date Lost"
              validateStatus={
                formik.touched.dateLost && formik.errors.dateLost ? "error" : ""
              }
        ...
        <Row gutter={[16, 16]}>
          <Col xs={24} sm={12}>
            <Form.Item
              ...
              help={formik.touched.contactEmail && formik.errors.contactEmail}
            >
              <Input
                name="contactEmail"
                onChange={formik.handleChange}
        ...
        <Row gutter={[16, 16]}>
          ...
          <Col xs={24}>
            <Form.Item
              ...
              label="Species Type"
              validateStatus={
                formik.touched.species && formik.errors.species ? "error" : ""
              }
        ...
        <Row gutter={16}>
          ...
          <Col span={12}>
            <Form.Item
              ...
              label="Size (kg)"
              validateStatus={
                formik.touched.size && formik.errors.size ? "error" : ""
              }
