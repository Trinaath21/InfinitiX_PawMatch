...
import { Layout, Form, Input, Button, Col, Row, Typography, message, Empty } from 'antd';
...
function ViewMyDonation() {
  ...
  const handleAddDonationClick = () => {
    navigate('/AddDonation'); // Navigate to AddDonation.js
  };
      ...
      <div style={{ width: '100%', maxWidth: '1000px', padding: '20px', background: '#fff', borderRadius: '8px' }}>
        ...
        {loading ? (
          ...
          <div style={{ textAlign: 'center', padding: '50px 0' }}>
            ...
            <Button type="primary" onClick={handleAddDonationClick} style={{ marginTop: '20px' }}>
              Add Donation Details
            </Button>
          </div>
        )}
