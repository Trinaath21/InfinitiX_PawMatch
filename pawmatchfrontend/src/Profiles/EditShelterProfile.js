...
const EditShelterProfile = () => {
  ...
  const handleSubmit = (values) => {
    ...
    axios
      .put("http://localhost:8000/api/updateShelterProfile", values, {
        headers: {
          Authorization: `Bearer ${authToken}`,
        },
      })
      .then((response) => {
        ...
        setProfile(response.data.profile);
        navigate("/main/profiles/shelter"); // Navigate to your desired page
      })
      .catch((err) => {
        ...
        >
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input detailed address!",
              },
            ]}
          >
            <Input />
          ...
          <Form.Item
            ...
            rules={[
              {
                required: true,
                message: "Please input number of pets!",
              },
            ]}
          >
